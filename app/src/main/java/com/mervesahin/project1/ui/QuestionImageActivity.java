...
public class QuestionImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String logTAG = "Question2Log";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryName=getIntent().getStringExtra("questionKey2");
    ...
    private void getQuestionList() {
        ...
        Log.d(logTAG,"questions/2/"+categoryName);

        db.collection("questions/2/"+categoryName)
                .get()
                ...
                .setListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (value == 0) {
                            switch (viewNum) {
                                case 0:
                                    Glide.with(QuestionImageActivity.this).load(questionList.get(quesNum).getQuestion()).into(question2);
